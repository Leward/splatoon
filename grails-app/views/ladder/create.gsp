...
<div class="ladder-page">
    ...
    <nav>
        <ul class="breadcrumb">
            ...
            <li>Ajouter un résultat</li>
        </ul>
    </nav>

    <div class="card">
        <header><h2>Ajouter un résultat au ladder</h2></header>
        <main>
            ...
            <g:form mapping="admin_ladder_add_result" params="${[eventId: ladder.event.id]}" method="post">
                <fieldset class="form">
                    <f:with bean="ladder">
